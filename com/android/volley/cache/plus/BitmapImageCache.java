...
public class BitmapImageCache implements ImageCache {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v4, resolved type: com.android.volley.cache.plus.BitmapImageCache} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.android.volley.cache.plus.BitmapImageCache getInstance(androidx.fragment.app.FragmentManager r3, java.lang.String r4, int r5) {
        /*
            r0 = 0
            r1 = 0
            if (r3 == 0) goto L_0x000f
            com.android.volley.cache.plus.BitmapImageCache$RetainFragment r1 = getRetainFragment(r3, r4)
            java.lang.Object r2 = r1.getObject()
            r0 = r2
            com.android.volley.cache.plus.BitmapImageCache r0 = (com.android.volley.cache.plus.BitmapImageCache) r0
        L_0x000f:
            if (r0 != 0) goto L_0x001c
            com.android.volley.cache.plus.BitmapImageCache r2 = new com.android.volley.cache.plus.BitmapImageCache
            r2.<init>(r5)
            r0 = r2
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.volley.cache.plus.BitmapImageCache.getInstance(androidx.fragment.app.FragmentManager, java.lang.String, int):com.android.volley.cache.plus.BitmapImageCache");
    }
    ...
    private void init(int memCacheSize) {
        ...
        this.mMemoryCache = new LruCache<String, BitmapDrawable>(memCacheSize) {
            ...
            public int sizeOf(String key, BitmapDrawable bitmap) {
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        synchronized (this.mMemoryCache) {
            BitmapDrawable memBitmap = this.mMemoryCache.get(data);
            if (memBitmap != null) {
