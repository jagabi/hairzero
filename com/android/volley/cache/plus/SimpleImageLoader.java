...
public class SimpleImageLoader extends ImageLoader {
    ...
    public SimpleImageLoader(RequestQueue queue) {
        this(queue, (ImageCache) BitmapImageCache.getInstance((FragmentManager) null));
    }
    ...
    public ImageLoader.ImageContainer get(String requestUrl, ImageView imageView, Drawable placeHolder, int maxWidth, int maxHeight) {
        ...
        if (requestUrl != null) {
            ImageLoader.ImageContainer imageContainer2 = get(requestUrl, getImageListener(getResources(), imageView, placeHolder, this.mFadeInImage), maxWidth, maxHeight);
    ...
    public ImageLoader.ImageContainer set(String requestUrl, ImageView imageView, Drawable placeHolder, int maxWidth, int maxHeight, Bitmap bitmap) {
        ...
        if (requestUrl != null) {
            ImageLoader.ImageContainer imageContainer2 = set(requestUrl, getImageListener(getResources(), imageView, placeHolder, this.mFadeInImage), maxWidth, maxHeight, bitmap);
            imageView.setTag(imageContainer2);
            return imageContainer2;
        }
        if (!(imageView instanceof PhotoView)) {
            ...
            public void onResponse(ImageLoader.ImageContainer response, boolean isImmediate) {
                ...
                if (response.getBitmap() != null) {
                    ...
                    if (imageView instanceof PhotoView) {
                        ...
                        BitmapDrawable bitmap = response.getBitmap();
                    ...
                    BitmapDrawable bitmap2 = response.getBitmap();
    ...
    public static void setImageBitmap(final ImageView imageView, final BitmapDrawable bitmapDrawable, Resources resources, boolean fadeIn) {
    ...
    /* access modifiers changed from: private */
    public static void setPhotoImageBitmap(final PhotoView imageView, final BitmapDrawable bitmapDrawable, Resources resources, boolean fadeIn) {
        Drawable initialDrawable;
        if (fadeIn && Utils.hasHoneycombMR1()) {
            imageView.animate().scaleY(0.95f).scaleX(0.95f).alpha(0.0f).setDuration(imageView.getDrawable() == null ? 0 : 100).setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
