...
public class HttpClientStack implements HttpStack {
    ...
    static HttpUriRequest createHttpRequest(Request<?> request, Map<String, String> map) throws AuthFailureError, IOException {
    ...
    private static void setEntityIfNonEmptyBody(HttpEntityEnclosingRequestBase httpRequest, Request<?> request) throws IOException, AuthFailureError {
        if (request instanceof MultiPartRequest) {
            ...
            httpRequest.addHeader("Content-Type", String.format("multipart/form-data; charset=%s; boundary=%s", new Object[]{((MultiPartRequest) request).getProtocolCharset(), multipartEntity.getBoundary()}));
            ...
            for (String key2 : filesToUpload.keySet()) {
                ...
                if (!file.exists()) {
                    ...
                    multipartEntity.addPart(new FilePart(key2, file, (String) null, (String) null));
                } else {
        ...
        httpRequest.addHeader("Content-Type", request.getBodyContentType());
