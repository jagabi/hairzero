...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0117R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0117R.attr.badgeStyle;
    ...
    private BadgeDrawable(Context context, int badgeResId, int defStyleAttr, int defStyleRes, BadgeState.State savedState) {
        ...
        setTextAppearanceResource(C0117R.style.TextAppearance_MaterialComponents_Badge);
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (anchorViewParent == null || anchorViewParent.getId() != C0117R.C0120id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != anchorViewParent) {
                ...
                frameLayout.setId(C0117R.C0120id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        if (hasNumber()) {
            i = C0117R.dimen.mtrl_badge_text_horizontal_edge_offset;
        } else {
            i = C0117R.dimen.mtrl_badge_horizontal_edge_offset;
        }
    ...
    private String getBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C0117R.string.mtrl_exceed_max_badge_number_suffix), new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    }
