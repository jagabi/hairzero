...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        this.badgeRadius = (float) a.getDimensionPixelSize(C0117R.styleable.Badge_badgeRadius, res.getDimensionPixelSize(C0117R.dimen.mtrl_badge_radius));
        this.badgeWidePadding = (float) a.getDimensionPixelSize(C0117R.styleable.Badge_badgeWidePadding, res.getDimensionPixelSize(C0117R.dimen.mtrl_badge_long_text_horizontal_padding));
        this.badgeWithTextRadius = (float) a.getDimensionPixelSize(C0117R.styleable.Badge_badgeWithTextRadius, res.getDimensionPixelSize(C0117R.dimen.mtrl_badge_with_text_radius));
        int unused2 = state.alpha = storedState.alpha == -2 ? 255 : storedState.alpha;
        if (storedState.contentDescriptionNumberless == null) {
            charSequence = context.getString(C0117R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (storedState.contentDescriptionQuantityStrings == 0) {
            i = C0117R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (storedState.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i2 = C0117R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (storedState.maxCharacterCount == -2) {
            i3 = a.getInt(C0117R.styleable.Badge_maxCharacterCount, 4);
        } else {
        ...
        } else if (a.hasValue(C0117R.styleable.Badge_number)) {
            int unused9 = state.number = a.getInt(C0117R.styleable.Badge_number, 0);
        } else {
            int unused10 = state.number = -1;
        }
        if (storedState.backgroundColor == null) {
            i4 = readColorFromAttributes(context, a, C0117R.styleable.Badge_backgroundColor);
        } else {
        ...
        } else if (a.hasValue(C0117R.styleable.Badge_badgeTextColor)) {
            Integer unused13 = state.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, a, C0117R.styleable.Badge_badgeTextColor));
        } else {
            Integer unused14 = state.badgeTextColor = Integer.valueOf(new TextAppearance(context, C0117R.style.TextAppearance_MaterialComponents_Badge).getTextColor().getDefaultColor());
        }
        if (storedState.badgeGravity == null) {
            i5 = a.getInt(C0117R.styleable.Badge_badgeGravity, 8388661);
        } else {
        ...
        if (storedState.horizontalOffsetWithoutText == null) {
            i6 = a.getDimensionPixelOffset(C0117R.styleable.Badge_horizontalOffset, 0);
        } else {
            i6 = storedState.horizontalOffsetWithoutText.intValue();
        }
        Integer unused16 = state.horizontalOffsetWithoutText = Integer.valueOf(i6);
        if (storedState.horizontalOffsetWithoutText == null) {
            i7 = a.getDimensionPixelOffset(C0117R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (storedState.horizontalOffsetWithText == null) {
            i8 = a.getDimensionPixelOffset(C0117R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.verticalOffsetWithText == null) {
            i9 = a.getDimensionPixelOffset(C0117R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int badgeResId, int defStyleAttr, int defStyleRes) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attrs, C0117R.styleable.Badge, defStyleAttr, style, new int[0]);
    }
