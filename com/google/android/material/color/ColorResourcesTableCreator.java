...
final class ColorResourcesTableCreator {
    ...
    private static class PackageChunk {
        ...
        private final StringPoolChunk typeStrings = new StringPoolChunk(false, "?1", "?2", "?3", "?4", "?5", TypedValues.Custom.S_COLOR);
        ...
        public void writeTo(ByteArrayOutputStream outputStream) throws IOException {
            this.header.writeTo(outputStream);
            outputStream.write(ColorResourcesTableCreator.intToByteArray(this.packageInfo.f168id));
    ...
    private static class TypeSpecChunk {
        ...
        public void writeTo(ByteArrayOutputStream outputStream) throws IOException {
            this.header.writeTo(outputStream);
            outputStream.write(new byte[]{ColorResourcesTableCreator.TYPE_ID_COLOR, 0, 0, 0});
    ...
    static class PackageInfo {
        ...
        /* renamed from: id */
        public final int f168id;
        /* access modifiers changed from: private */
        public final String name;

        PackageInfo(int id, String name2) {
            this.f168id = id;
            this.name = name2;
        }
    }
