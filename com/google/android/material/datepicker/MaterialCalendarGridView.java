...
final class MaterialCalendarGridView extends GridView {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (MaterialDatePicker.isFullscreen(getContext())) {
            setNextFocusLeftId(C0117R.C0120id.cancel_button);
            setNextFocusRightId(C0117R.C0120id.confirm_button);
        }
                ...
                if (!skipMonth(firstOfMonth, lastOfMonth, Long.valueOf(startItem), Long.valueOf(endItem))) {
                    ...
                    while (row <= lastRow) {
                        ...
                        if (!isRtl) {
                            ...
                            i = lastHighlightPosition > firstRow3 ? getWidth() : rangeHighlightEnd;
                        } else {
                            left = lastHighlightPosition > firstRow3 ? 0 : rangeHighlightEnd;
                        ...
                        int lastHighlightPosition3 = i;
                        int i5 = firstRow3;
                        int i6 = left2;
                        int i7 = top;
                        int i8 = lastHighlightPosition3;
                        int i9 = bottom;
                        canvas.drawRect((float) left2, (float) top, (float) lastHighlightPosition3, (float) bottom, calendarStyle.rangeFill);
                        row++;
                        materialCalendarGridView = this;
