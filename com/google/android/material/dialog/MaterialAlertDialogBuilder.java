...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0117R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0117R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0117R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, C0117R.attr.colorSurface, getClass().getCanonicalName());
