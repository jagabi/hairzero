...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius, float shadowSize2, float maxShadowSize2) {
        super(content);
        this.shadowStartColor = ContextCompat.getColor(context, C0117R.C0118color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C0117R.C0118color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C0117R.C0118color.design_fab_shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        fArr[1] = 1056964608;
        fArr[2] = 1065353216;
        paint2.setShader(new LinearGradient(0.0f, f3, 0.0f, f4, iArr, fArr, Shader.TileMode.CLAMP));
