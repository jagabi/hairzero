...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0117R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0117R.attr.snackbarButtonStyle, C0117R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            ...
            if (hasSnackbarContentStyleAttrs(context)) {
                i = C0117R.layout.mtrl_layout_snackbar_include;
            } else {
                i = C0117R.layout.design_layout_snackbar_include;
            }
