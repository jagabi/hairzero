...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0117R.C0120id.snackbar_text);
        this.actionView = (Button) findViewById(C0117R.C0120id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float actionTextColorAlpha) {
        if (actionTextColorAlpha != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0117R.attr.colorSurface), this.actionView.getCurrentTextColor(), actionTextColorAlpha));
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getOrientation() != 1) {
            int multiLineVPadding = getResources().getDimensionPixelSize(C0117R.dimen.design_snackbar_padding_vertical_2lines);
            int singleLineVPadding = getResources().getDimensionPixelSize(C0117R.dimen.design_snackbar_padding_vertical);
