...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        int drawableResId;
        float popupCornerRadius = (float) this.context.getResources().getDimensionPixelOffset(C0117R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = (float) this.context.getResources().getDimensionPixelOffset(C0117R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0117R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        if (this.customEndIcon == 0) {
            drawableResId = IS_LOLLIPOP ? C0117R.C0119drawable.mtrl_dropdown_arrow : C0117R.C0119drawable.mtrl_ic_arrow_drop_down;
        } else {
            drawableResId = this.customEndIcon;
        }
        this.textInputLayout.setEndIconDrawable(drawableResId);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0117R.string.exposed_dropdown_menu_content_description));
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.accessibilityManager.addTouchExplorationStateChangeListener(new AccessibilityManager.TouchExplorationStateChangeListener() {
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        if (!isEditable(editText)) {
            ...
            int rippleColor = MaterialColors.getColor(editText, C0117R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0117R.attr.colorSurface);
