...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0117R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0117R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0117R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0117R.styleable.MaterialAutoCompleteTextView_android_inputType) && attributes.getInt(C0117R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
            setKeyListener((KeyListener) null);
        }
        this.simpleItemLayout = attributes.getResourceId(C0117R.styleable.MaterialAutoCompleteTextView_simpleItemLayout, C0117R.layout.mtrl_auto_complete_simple_item);
        ...
        if (attributes.hasValue(C0117R.styleable.MaterialAutoCompleteTextView_simpleItems)) {
            setSimpleItems(attributes.getResourceId(C0117R.styleable.MaterialAutoCompleteTextView_simpleItems, 0));
        }
        attributes.recycle();
    }
