...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Chip chip2 = (Chip) inflater.inflate(C0117R.layout.material_time_chip, this, false);
        this.chip = chip2;
        chip2.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout2 = (TextInputLayout) inflater.inflate(C0117R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C0117R.C0120id.material_label);
