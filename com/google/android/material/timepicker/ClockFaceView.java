...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attrs) {
        this(context, attrs, C0117R.attr.materialClockStyle);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0117R.styleable.ClockFaceView, defStyleAttr, C0117R.style.Widget_MaterialComponents_TimePicker_Clock);
        Resources res = getResources();
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, a, C0117R.styleable.ClockFaceView_clockNumberTextColor);
        this.textColor = colorStateList;
        LayoutInflater.from(context).inflate(C0117R.layout.material_clockface_view, this, true);
        ClockHandView clockHandView2 = (ClockHandView) findViewById(C0117R.C0120id.material_clock_hand);
        this.clockHandView = clockHandView2;
        this.clockHandPadding = res.getDimensionPixelSize(C0117R.dimen.material_clock_hand_padding);
        ...
        int defaultBackgroundColor = AppCompatResources.getColorStateList(context, C0117R.C0118color.material_timepicker_clockface).getDefaultColor();
        ColorStateList backgroundColor = MaterialResources.getColorStateList(context, a, C0117R.styleable.ClockFaceView_clockFaceBackgroundColor);
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                int index = ((Integer) host.getTag(C0117R.C0120id.material_value_index)).intValue();
                if (index > 0) {
            ...
            public boolean performAccessibilityAction(View host, int action, Bundle args) {
                ...
                ClockFaceView.this.clockHandView.onTouchEvent(MotionEvent.obtain(eventTime, j, 0, f, y, 0));
                ClockFaceView.this.clockHandView.onTouchEvent(MotionEvent.obtain(eventTime, j, 1, f, y, 0));
                return true;
            }
        };
        ...
        this.minimumHeight = res.getDimensionPixelSize(C0117R.dimen.material_time_picker_minimum_screen_height);
        this.minimumWidth = res.getDimensionPixelSize(C0117R.dimen.material_time_picker_minimum_screen_width);
        this.clockSize = res.getDimensionPixelSize(C0117R.dimen.material_clock_size);
    }
    ...
    private void updateTextViews(int r9) {
        ...
        L_0x002e:
            ...
            int r5 = com.google.android.material.C0117R.layout.material_clockface_textview
        ...
        L_0x0042:
            ...
            r5 = r5[r2]
            r3.setText(r5)
            int r5 = com.google.android.material.C0117R.C0120id.material_value_index
    ...
    private void findIntersectingTextView() {
        ...
        for (int i = 0; i < this.textViewPool.size(); i++) {
            ...
            if (tv != null) {
                ...
                tv.setSelected(selectorBox.contains((float) this.textViewRect.centerX(), (float) this.textViewRect.centerY()));
                tv.getPaint().setShader(getGradientForTextView(selectorBox, this.textViewRect, tv));
                tv.invalidate();
            }
        }
    }
