...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0117R.C0120id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0117R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0117R.C0120id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0117R.C0120id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                int period = checkedId == C0117R.C0120id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.minuteView = (Chip) findViewById(C0117R.C0120id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0117R.C0120id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C0117R.C0120id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0117R.C0120id.selection_type, 12);
        this.hourView.setTag(C0117R.C0120id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        int checkedId;
        if (period == 1) {
            checkedId = C0117R.C0120id.material_clock_period_pm_button;
        } else {
            checkedId = C0117R.C0120id.material_clock_period_am_button;
        }
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0117R.C0120id.material_clock_display, sideToClear);
