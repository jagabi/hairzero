...
public abstract class PermissionBuilder<T extends PermissionBuilder> {
    ...
    public PermissionBuilder(Context context2) {
        ...
        this.deniedCloseButtonText = context2.getString(C0122R.string.tedpermission_close);
        this.rationaleConfirmText = context2.getString(C0122R.string.tedpermission_confirm);
