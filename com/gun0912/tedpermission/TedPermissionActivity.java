...
public class TedPermissionActivity extends AppCompatActivity {
    ...
    private void requestWindowPermission() {
        final Intent intent = new Intent("android.settings.action.MANAGE_OVERLAY_PERMISSION", Uri.fromParts("package", this.packageName, (String) null));
        if (!TextUtils.isEmpty(this.rationale_message)) {
            new AlertDialog.Builder(this, C0122R.style.Theme_AppCompat_Light_Dialog_Alert).setMessage(this.rationale_message).setCancelable(false).setNegativeButton((CharSequence) this.rationaleConfirmText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public void checkPermissions(boolean fromOnActivityResult) {
        ...
        if (needPermissions.isEmpty()) {
            permissionResult((List<String>) null);
    ...
    public void permissionResult(List<String> deniedPermissions) {
        ...
        if (deque != null) {
            PermissionListener listener = deque.pop();
    ...
    private void showRationaleDialog(final List<String> needPermissions) {
        new AlertDialog.Builder(this, C0122R.style.Theme_AppCompat_Light_Dialog_Alert).setTitle(this.rationaleTitle).setMessage(this.rationale_message).setCancelable(false).setNegativeButton((CharSequence) this.rationaleConfirmText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void showPermissionDenyDialog(final List<String> deniedPermissions) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this, C0122R.style.Theme_AppCompat_Light_Dialog_Alert);
        builder.setTitle(this.denyTitle).setMessage(this.denyMessage).setCancelable(false).setNegativeButton((CharSequence) this.deniedCloseButtonText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (this.hasSettingButton) {
            if (TextUtils.isEmpty(this.settingButtonText)) {
                this.settingButtonText = getString(C0122R.string.tedpermission_setting);
            }
            builder.setPositiveButton((CharSequence) this.settingButtonText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public void showWindowPermissionDenyDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, C0122R.style.Theme_AppCompat_Light_Dialog_Alert);
        builder.setMessage(this.denyMessage).setCancelable(false).setNegativeButton((CharSequence) this.deniedCloseButtonText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (this.hasSettingButton) {
            ...
            builder.setPositiveButton((CharSequence) this.settingButtonText, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    TedPermissionActivity.this.startActivityForResult(new Intent("android.settings.action.MANAGE_OVERLAY_PERMISSION", Uri.fromParts("package", TedPermissionActivity.this.packageName, (String) null)), 31);
                }
            });
        }
        builder.show();
